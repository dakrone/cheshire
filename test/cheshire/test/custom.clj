...
(scenario
  :reminder "exceptions should throw Exceptions"
...
(scenario
  :reminder "test-add-remove-encoder"
...
(scenario
  :reminder "test-shadowing-default-encoder"
  (json/remove-encoder java.util.Date)
  (json/add-encoder java.util.Date
                    (fn [d jg] (json/encode-str "foo" jg)))
  (expect "\"foo\"" (json/encode* (java.util.Date.)))
  (expect "\"foo\"" (json/encode* :foo))
  (json/remove-encoder java.util.Date)
  (json/add-encoder java.util.Date json/encode-date)
  (expect (comp not nil?) (json/encode (java.util.Date.))))
